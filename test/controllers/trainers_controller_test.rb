...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { email: @trainer.email, location: @trainer.location, name: @trainer.name, phone: @trainer.phone, radius: @trainer.radius, team: @trainer.team } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { email: @trainer.email, location: @trainer.location, name: @trainer.name, phone: @trainer.phone, radius: @trainer.radius, team: @trainer.team } }
